      ...
      <div class="col-xl-16">
         <div class="card shadow mb-4">
            <div
               ...
               <h6 class="m-0 font-weight-bold text-dark">Emp Announcements</h6>
               <form action="/addeAnnouncements">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <span class="input-group">
                                       ...
                                       <form action ="/editEAnnouncements" method="get">
                                          <input type="hidden" id="EannID" name="EannID" value="{{ $ann->id }}">
                                          ...
                                          <div class="modal-dialog modal-lg">
                                             <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                      <form action ="deleteEAnn" method="get" >
                                                         @csrf
