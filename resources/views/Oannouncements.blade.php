      ...
      <div class="col-xl-16">
         <div class="card shadow mb-4">
            <div
               ...
               <h6 class="m-0 font-weight-bold text-dark">Ofw Announcements</h6>
               <form action="/addoAnnouncements">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <span class="input-group" style="justify-content:center">
                                       ...
                                       <form action ="/editOAnnouncements" method="get">
                                          <input type="hidden" id="OannID" name="OannID" value="{{ $ann->id }}">
                                          ...
                                          <div class="modal-dialog modal-lg">
                                             <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                      <form action ="deleteOAnn" method="get" >
                                                         @csrf
