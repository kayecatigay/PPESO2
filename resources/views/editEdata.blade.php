...
@section('maincontent')       
        ...
        <form action ="/updateEemp" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="id"></label>
            <input type="hidden" class="form-control" id="id" name="id" value={{$eEMP[0]->id}}>
          </div>
          <p><h4>Personal Data</h4></p>
          <div class="form-group">
            <label for="name">Name</label>
            <input type="text" class="form-control" id="name" name="name"  value={{$eEMP[0]->name}}>
          </div>
          <div class="row">
            ...
            <div class="col">
                ...
                <select class="form-control" name="gender" id="gender" value={{$eEMP[0]->gender}}>
