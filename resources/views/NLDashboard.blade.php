...
<link href="assets/css/sb-admin-2.min.css" rel="stylesheet">
    ...
    <div id="content">
        ...
        <!-- Begin Page Content -->
        <div class="container-fluid" style="font-family: arial, serif;  width: 70%;">
            @section('dashboard')
                <!-- Page Heading -->
                ...
                <div class="row xl-4 col-lg-5 center" style=" margin: auto; margin-right: auto; width: 200%;">
                    <div class="card shadow mb-3">
                        <!-- Card Header - Dropdown -->
                        <div
                            class="card-header py-7 d-flex flex-row">
                            <h6 class="m-0 font-weight-bold text-dark" style="display: block; margin-left: auto; margin-right:suto;">ACCEPTED</h6>
