                        ...
                        <li class="nav-item">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <a class="collapse-item" href="/AllSched">Schedules</a>
                                    <a class="collapse-item" href="buttons.html">Tracking</a>
                                    <a class="collapse-item" href="cards.html">Announcements</a>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    <h6 class="collapse-header">SERVICES</h6>
                                    <a class="collapse-item" href="/showAllSApp">Applicants</a>
                                    <a class="collapse-item" href="/AllSched">Works Available</a>
                                    <a class="collapse-item" href="buttons.html">Schedules</a>
                                    <a class="collapse-item" href="cards.html">Announcements</a>
                                </div>
                            </div>
                        </li>
