            ...
            <ul class="navbar-nav bg-success sidebar sidebar-dark accordion" id="accordionSidebar">
                @section('sidebar content')
                    ...
                    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admindashboard">
                        ...
                        <div class="sidebar-brand-text mx-3">Ppeso <br> Scholar Admin </div>
                    </a>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseScholar" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="/newScholar">New</a>
                                <a class="collapse-item" href="/oldScholar">Old</a>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div id="collapsedsched" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <h6 class="collapse-header">Custom Components:</h6>
                                <a class="collapse-item" href="/SchedExam">Exam</a>
