                ...
                <div class="card shadow mb-4" style="height: 190px; width:400px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress mb-1">
                            <div class="progress-bar bg-dark" role="progressbar" style="width: {{ $totalpeap }}%;" aria-valuenow="{{ $totalpeap }}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h4 class="small font-weight-bold">EMP
                            <span class="float-right">{{ $totalemp }}</span>
                        </h4>
                        <div class="progress mb-1">
                            <div class="progress-bar bg-dark" role="progressbar" style="width: {{ $totalemp }}%;" aria-valuenow="{{ $totalemp }}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h4 class="small font-weight-bold">OFW<span class="float-right">{{ $totalofw }}</span>
                        </h4>
                        <div class="progress mb-1">
                            <div class="progress-bar bg-dark" role="progressbar" style="width: {{ $totalofw }}%;" aria-valuenow="{{ $totalofw }}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
