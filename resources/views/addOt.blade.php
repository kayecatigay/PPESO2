   ...
   <div class="form-group">
      ...
      <div class="container">
         ...
         <div class="row form-group">
            ...
            <div class="col">
               <div class="col">
                  ...
                  <input type="text" required class="form-control" id="Company" name="Company" placeholder="Name of Company / NA">
               </div>
            </div>
         </div>
         <div class="row form-group">
            ...
            <div class="col-5">
               ...
               <input type="text" required class="form-control" id="PeriodOfEmp" name="PeriodOfEmp" placeholder="ex: 8 months">
            </div>
         </div> <br>
         ...
         <div class="row">
            <div class="col-5">&nbsp;</div>
            <div class="col">
               <button type="submit" style="background-color:#5F9EA0; border:none; font-size: 16px; border-radius: 4px;" value="Submit">Submit</button>
            </div>
            <div class="col">&nbsp;</div>
         </div>
      </div>
