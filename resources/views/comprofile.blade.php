                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col form-group">
                                       <label for="pass"> Password:</label>
                                        <input type="password" id="pass" name="pass" value="1111">
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <input type="text" id="cname" name="cname" value="{{$show[0]->cname}}">
                                    </div>
                                    <div class="col form-group">
                                       <label for="email"> Email Address:</label>
                                        <input type="email" id="email" name="email" value="{{$show[0]->email}}"><br>
                                    </div>
                                    <div class="col form-group">
                                        <label for="contact">Contact Number:</label>
                                        <input type="text" id="contact" name="contact" value="{{$show[0]->contact}}"><br>
                                    </div>
