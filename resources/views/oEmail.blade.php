...
@section('maincontent')        
    <div class="col-lg-12 mt-5 mt-lg-0" >
        ...
        <form action="sendoNotifMail" method="get" >
    ...
    subjectSelect.addEventListener("change", function () {
        ...
        // Display a message based on the selected value
         if (selectedValue === "Interview") {
            messageElement.textContent = "You are required to comply in an interview regarding your application in this program. Please bring ID, passport, POE(Proof of Overseas Employment), and a valid VISA.";
